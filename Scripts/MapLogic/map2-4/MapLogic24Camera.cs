...
public class MapLogic24Camera : MonoBehaviour
{
    ...
    void FixCameraPos()
    {
        ...
        targetPos = new Vector3(player.transform.position.x + 5, player.transform.position.y, gameObject.transform.position.z);
